...
export const en = {
  ...
  leetcode: {
    ...
    filters: 'Filters',
    filtersDescription: 'Filter problems by difficulty, category or search',
    searchPlaceholder: 'Search by title, number or category...',
    ...
    intuition: 'Intuition',
    approach: 'Approach',
    implementationIn: 'Implementation in',
